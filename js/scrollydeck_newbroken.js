...
var xBG, yBG;
 ...
 var canvas0 = document.getElementById( 'big0' );
 

     canvasBG = canvas0.appendChild(document.createElement("canvas")),
     canvasBG.style.position = "absolute";
     canvasBG.style.zIndex = "999999999";
    canvasBG.style.top = canvas0.offsetTop + "px";
    canvasBG.style.left = canvas0.offsetLeft + "px";
...
var sketch = d3.select("#vis").append("custom:sketch")
        .attr("width", width)
        .attr("height", height)
...
function mousemovecirclesload(event) {
    ...
    for(var loc3 = 0; loc3 < 3; loc3++) {


  sketch.append("custom:circle")
      .attr("x", ((width/3)*loc3))
      .attr("y", ((height/3)*loc3))
      .attr("radius", 0)
  ...
  sketch.append("custom:circle")
    ...
    .transition()
      ...
      .remove();
         ...
         var xBG = ( event.clientX / window.innerWidth ) * 2 - 1;
          var yBG =  - ( event.clientY / window.innerHeight ) * 2 + 1;

 
 ////// getPosition(event); 
      var grd = ctxBG.createRadialGradient(event.xBG, event.yBG, 0, event.xBG, event.yBG, 50);
    grd.addColorStop(0, "rgba(255,255,255,.6)"); 
    grd.addColorStop(1, "transparent"); 
    ctxBG.fillStyle = grd;
    ctxBG.beginPath();
    ctxBG.arc(xBG, yBG, 10, 0, 2 * Math.PI);
    ctxBG.fill();
    ctxBG.closePath();
...
big8bg.setAttribute("style", "background-image: url(images/wildbeast40.jpg); ");
...
////////////////document.body.style.backgroundImage = "url(8.jpg)";
var big8bg = document.getElementById( 'big8' );
big8bg.setAttribute("style", "background: none; ");
